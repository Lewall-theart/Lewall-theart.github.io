...
Tên challenge đã là một cái bẫy đầu tiên. **"scaped Reality"** — thiếu chữ `e` ở đầu. Đó không phải typo. Đó là hint: **e-scaped**, hay nói cách khác, **escaped characters** là trung tâm của bài này.
...
*"scaped Reality"* không phải typo — đó là **e-scaped**, gợi ý thẳng đến escape characters và URL encoding. Trong CTF, tên challenge thường chứa ít nhất một hint về phương pháp giải.
