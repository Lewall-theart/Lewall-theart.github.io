...
Tên challenge đã là một cái bẫy đầu tiên. **"Escaped Reality"** — thiếu chữ `e` ở đầu. Đó không phải typo. Đó là hint: **escaped**, hay nói cách khác, **escaped characters** là trung tâm của bài này.
